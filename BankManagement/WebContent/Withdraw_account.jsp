...
<div>
	...
	<div style="margin-left: 10%;">
		<div class="container main1">
			...
			<fieldset>
				<form action="Withdraw Account" method="post" display=table>

					<div class="main">
						<h1 style="margin-left: 25%;">Withdraw Account</h1>
					</div>
					<div class="main">
					...
					<div class="main">
						<label for="withdraw">Withdraw Amount :</label> <input type="text"
							id="withdraw" name="withdrawamount"><br>
					</div>
				<br>
				<div>
